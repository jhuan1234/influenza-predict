...
if st.button("Predict"):
   ...
   # Calculate SHAP values and display force plot   
    ...
    print(shap_values[0][:,1].shape,feature_values.shape)
    shap.force_plot(explainer.expected_value[1], shap_values[0][:,1],feature_values,feature_names=feature_names,show=False)
